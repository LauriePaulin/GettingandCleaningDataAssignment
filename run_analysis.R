#----------------Good practice to set the working directory
...
#----------------Step one in the assignment - Merge the training and the test data sets to create one data set.
...
#----------------Save Tidy data set to file for upload to assignment
